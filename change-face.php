...
<html lang="en">
          ...
          <section class="wrapper">
              <div class="row">
                  <div class="col-lg-9 main-chart">
                    ...
                    <br>
                      <form class="form-horizontal style-form" name="faceform" method="post" action="settings.php" enctype="multipart/form-data">
                          <input type="hidden" name="profile_picture_updated" value="1" />
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">&emsp;Choose file :</label>
                            <div class="col-sm-10">
                              <input name="facefile" type="file" id="imgfile" class="file-input" required>
                            </div>
                          </div>
                          ...
                          <div style="margin-left:40px;" >
                              <button type="button" id="boton" style="width:120px" onclick="mysubmit()" class="btn btn-round btn-success">Submit</button>
                          </div>
                          <br><br>
  ...
  function mysubmit() {
    ...
    setTimeout(function(){document.forms["faceform"].submit();},1200);
  }
  </script>
