  ...
  <body>
    ...
    <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
          ...
          <section class="wrapper">
              <div class="row">
                  <div class="col-lg-9 main-chart" align="center">
                      ...
                      <br><br><br>
                      <a href="login.php"><button type="button" class="btn btn-theme btn-lg btn-block">Continue to the Login Page &gt;</button></a>
                  </div>
              </div><!--/row -->
          </section>
      </section>
      ...
      <!--main content end-->
      <!--footer start--><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
